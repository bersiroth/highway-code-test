...
class Container(containers.DeclarativeContainer):
    ...
    statistic_repository = providers.Factory(
        JsonStatisticRepository
    )
    cli_render = providers.Factory(
        ClickCliRender
    )

    cli_render_question_manager = providers.Factory(
        CliRenderQuestionManager,
        cli_render=cli_render
    )
    cli_render_question = providers.Factory(
        CliRenderQuestion,
        cli_render=cli_render
    )
    cli_render_statistic = providers.Factory(
        CliRenderStatistic,
        cli_render=cli_render
    )
    ...
    statistic_manager = providers.Factory(
        ...
        cli_render_statistic=cli_render_statistic
    )
    ...
    statistic_handler = providers.Factory(
        StatisticHandler,
        statistic_manager=statistic_manager
    )
